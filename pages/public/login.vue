	...
	<view class="container">
		...
		<view class="mp_wxBox">
			<view>
				...
				<button v-show="weixinPhone" style="background: #01993A;color: #FFFFFF;" class="bottom"
		...
		<view style="text-align: center;">
			<view class="footers">
				<!-- 	<u-checkbox v-model="checked" active-color="#01993A" style="margin-right: 10rpx;"
		...
		<view style="text-align: center;">
			...
			<view style="font-size: 28upx;margin-top: 32upx">欢迎使用省钱兄陪玩系统</view>
			...
			<view class="footers">
				...
				<image v-else @tap="isShowAgree"
					src="https://api.shengqianxiong.com.cn/img/20201112/1e9102fc891f4d86a13c7b2ba6921cba.png"
					style="width: 36upx;height: 36upx;"></image>
				<!-- <u-checkbox v-model="checked" active-color="#01993A" style="margin-right: 10rpx;" shape="circle"></u-checkbox> -->
				<!-- <text>同意</text> -->
				<!-- 协议地址 -->
				<navigator url="/my/setting/mimi" open-type="navigate">《隐私政策》</navigator>
				和
